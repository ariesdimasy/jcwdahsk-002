...
export declare function updateTodo(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function deleteTodo(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
